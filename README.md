...
1. **Детекция лица**: Используется OpenCV Haar Cascades для поиска лица на изображении
   - Быстрая детекция без дополнительных зависимостей
   - Работает локально
...
Используется **OpenCV Haar Cascades**:
- Быстрая и надёжная детекция лиц
- Не требует дополнительных моделей или зависимостей
- Работает локально без интернета

### Обработка изображений

- **Pillow (PIL)** для основной работы с изображениями
- **OpenCV** для детекции лиц и обработки изображений
